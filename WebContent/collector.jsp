...
<div id="view">
  ...
  <div id="head"> 
    ...
    <div id="mainMenu"> 
      <ul> <li><a href="home.jsp">HOME<span></span></a></li>
   ...
   <div id="logg">
  <form name="collector1" action="collector1" method=post>
 
    <font color="white" size="4">Collector Login</font>
<br>
  <div id="sss">

<div id="ss"><font color="pink" size="3">Name:</font></div>
