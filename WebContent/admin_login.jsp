...
<br>
<font color="white" size="3"><b>Admin</b></font>
  <div id="collector">
<form action="adview" name="adview" method=post>
<div id="sss">
...
<div id="collector">
<form action="adview1" name="adview1" method=post>
<div id="sss">

<div id="ss11"><font color="pink" size="2"><b>User Details</b></font></div>
<div id="ssx"><input type="submit" value=" view "></div></div></form>
